          ...
          child: Align(
            ...
            child: Column(
              ...
              children: [
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('ACCOUNT_PAGE_LOG_OUT_BTN_ON_TAP');
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('ACCOUNT_PAGE_EDIT_PROFILE_BTN_ON_TAP');
                    logFirebaseEvent('Button_navigate_to');

                    context.pushNamed('AccountChange');
                  },
                  text: 'Edit Profile',
                  options: FFButtonOptions(
                    height: 40.0,
                ...
                FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('ACCOUNT_PAGE_MY_POSTS_BTN_ON_TAP');
                    logFirebaseEvent('Button_navigate_to');

                    context.pushNamed('allUploadedPosts');
                  },
                  text: 'My posts',
                  options: FFButtonOptions(
                    height: 40.0,
