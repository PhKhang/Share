...
import 'account_change_model.dart';
export 'account_change_model.dart';

class AccountChangeWidget extends StatefulWidget {
  const AccountChangeWidget({super.key});

  @override
  State<AccountChangeWidget> createState() => _AccountChangeWidgetState();
}

class _AccountChangeWidgetState extends State<AccountChangeWidget> {
  late AccountChangeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AccountChangeModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'AccountChange'});
              ...
              child: Column(
                ...
                children: [
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              logFirebaseEvent(
                                  'ACCOUNT_CHANGE_PAGE_Text_i9iufq6v_ON_TAP');
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent(
                          'ACCOUNT_CHANGE_SAVE_CHANGES_BTN_ON_TAP');
